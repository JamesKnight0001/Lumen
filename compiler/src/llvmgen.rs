...
fn builtin_method(name: &str, nargs: usize) -> Option<(&'static str, usize)> {
    let sym = match name {
        ...
        "capitalize" => "lumen_str_capitalize",
        "swapcase" => "lumen_str_swapcase",
        "rfind" => "lumen_str_rfind",
        "ljust" => "lumen_str_ljust",
        "rjust" => "lumen_str_rjust",
        "center" => "lumen_str_center",
        "zfill" => "lumen_str_zfill",
